    ...
    API: {
      ...
      streamResponse: async function(userMessage, conversationId, messagesContainer) {
        ...
        try {
          ...
          const streamUrl = 'https://dh-shop-agent.daily-harvest-master-cloudflare-account.workers.dev/chat';
      ...
      fetchChatHistory: async function(conversationId, messagesContainer) {
        try {
          ...
          const historyUrl = `https://dh-shop-agent.daily-harvest-master-cloudflare-account.workers.dev/chat?history=true&conversation_id=${encodeURIComponent(conversationId)}`;
    ...
    Auth: {
      ...
      startTokenPolling: function(conversationId, messagesContainer) {
        ...
        const poll = async () => {
          ...
          try {
            const tokenUrl = 'https://dh-shop-agent.daily-harvest-master-cloudflare-account.workers.dev/auth/token-status?conversation_id=' +
